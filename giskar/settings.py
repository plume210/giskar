"""
Django settings for giskar project.
...
SECRET_KEY = 'django-insecure-ixv5f0-(6*jf8r)#-0=65=d-23yrs8**pv_o4@%h5k@^n+1kt%'
...
WSGI_APPLICATION = 'giskar.wsgi.application'
